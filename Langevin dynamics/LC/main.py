...
for i in range(trials_per_task):
    run_trial(
        ...
        initial_positions = [[0.2,1,0], [1.8,1,0]], # Change according to number of agents and their starting coordinates
        epochs = 2,  # Change # of epochs as needed
        output_dir = 'LeastCounts_trial_four_wells_asymmetric', # Change output directory as needed
