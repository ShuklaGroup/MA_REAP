...
def run_trial(potential, initial_positions, epochs, output_dir='', output_prefix='', **kwargs):
    ...
    **kwargs: used to specify model hyperparameters. Must include following keys:
        ...
        xlim (tuple of (x_min, x_max, x_stride)): used to define grid where area explored will be computed. (Will be replaced in the future to accommodate arbitrary dimensions.)
        ylim (tuple of (y_min, y_max, y_stride)): used to define grid where area explored will be computed. (Will be replaced in the future to accommodate arbitrary dimensions.)
